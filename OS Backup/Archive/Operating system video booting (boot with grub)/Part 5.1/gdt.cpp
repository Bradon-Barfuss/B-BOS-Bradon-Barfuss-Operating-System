...
//Because of the 
    ...
    i[0] = (uint32_t)this;//the address of the table
    i[1] = sizeof(GlobalDescriptorTable) << 16;//the last four bytes are the high bytes of the section, moved by 4 bytes to be the high bytes
