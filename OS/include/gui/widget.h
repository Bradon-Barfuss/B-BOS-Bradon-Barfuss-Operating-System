...
public:
    ...
    void DrawMouse(OS::common::GraphicsContext*, OS::common::int32_t x, OS::common::int32_t y);
    OS::common::GraphicsContext* GetWidgetGC(OS::common::GraphicsContext*);
    ...
    void UpdateMemWidget(OS::common::int32_t x, OS::common::int32_t y, OS::common::int32_t w, OS::common::int32_t h, OS::common::GraphicsContext* gc);
    void SetWidgetgc(OS::common::GraphicsContext* hold);
    OS::common::uint16_t* terminal_buffer;

    void PrintMainMenu();
    void inputchar(char c);

    void printf(char* c);
    void menulogic(char* c);
    char inputbuffer[50];
    int InputBufferPosition;
    void clear();
    char* username;
private:
    OS::common::GraphicsContext* Widgetlocalgc;
};
...
public:
    ...
    virtual void inputchar(char c, OS::common::int32_t x, OS::common::int32_t y);
    virtual void SetWidgetgcs(OS::common::GraphicsContext* hold);
    virtual void GetFocus(Widget* widget);
    ...
    Widget* findscreen(OS::common::int32_t x, OS::common::int32_t y);
