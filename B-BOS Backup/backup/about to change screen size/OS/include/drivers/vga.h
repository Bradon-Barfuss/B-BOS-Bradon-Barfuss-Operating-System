...
public:
    ...
    void PutText(int, int, OS::common::uint8_t r, OS::common::uint8_t g, OS::common::uint8_t b, char);
    void PrintString(int, int, OS::common::uint8_t r, OS::common::uint8_t g, OS::common::uint8_t b, char*);
    void DisplayMouse(OS::common::int32_t x, OS::common::int32_t y);
    OS::common::uint8_t getPixel(OS::common::int32_t x, OS::common::int32_t y);
};
