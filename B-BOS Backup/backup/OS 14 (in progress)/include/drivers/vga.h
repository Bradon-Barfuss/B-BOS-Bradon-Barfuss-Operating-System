...
public:
    ...
    virtual bool SupportedMode(OS::common::uint32_t width, OS::common::uint32_t height, OS::common::uint32_t colordepth);//check if the mode is supported
    ...
    virtual void FillRectangle(OS::common::int32_t x, OS::common::int32_t y, OS::common::uint32_t h, OS::common::uint32_t w,  OS::common::uint8_t r, OS::common::uint8_t g, OS::common::uint8_t b);
