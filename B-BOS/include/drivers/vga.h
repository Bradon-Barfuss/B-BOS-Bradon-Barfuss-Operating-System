...
public:
    ...
    void printchar(int, int, OS::common::uint8_t r, OS::common::uint8_t g, OS::common::uint8_t b, char);
    void printf(int, int, OS::common::uint8_t r, OS::common::uint8_t g, OS::common::uint8_t b, char*);
